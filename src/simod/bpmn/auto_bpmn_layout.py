...
SRC  = Path("../../../server/outputs/xor_filter_entire_case/best_result/filtered_event_log_20250627_124115.bpmn") 
DEST = Path("../../../server/outputs/xor_filter_entire_case/best_result/xor_filter_entire_case_diagram.bpmn")                     
